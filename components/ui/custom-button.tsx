...
const CustomButton = ({ onPress, title = 'Click Me', isLoading = false, extraClasses, textClasses, isDisable }: 
    { onPress: any, title: string, isLoading?: boolean , extraClasses?: any, textClasses?: any, isDisable?: boolean}) => {
    return (
        <TouchableOpacity
            onPress={onPress}
            activeOpacity={0.95}
